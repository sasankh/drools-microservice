...
public class RateLimitingFilter extends OncePerRequestFilter {
    ...
    public RateLimitingFilter(RateLimitingConfig.InMemoryRateLimitingService rateLimitingService, 
    ...
    private void addRateLimitHeaders(HttpServletResponse response, String clientId) {
        try {
            ...
            response.setHeader("X-RateLimit-Reset", String.valueOf(System.currentTimeMillis() / 1000 + info.getResetTimeSeconds()));
    ...
    private void writeRateLimitExceededResponse(HttpServletResponse response, String clientId) throws IOException {
