...
public class CircuitBreakerException extends RuntimeException {
    ...
    public CircuitBreakerException(String circuitBreakerName, String state) {
        super(String.format("Circuit breaker '%s' is %s - calls not permitted", circuitBreakerName, state));
        this.circuitBreakerName = circuitBreakerName;
        this.state = state;
    }
    
    public CircuitBreakerException(String circuitBreakerName, String state, Throwable cause) {
        super(String.format("Circuit breaker '%s' is %s - calls not permitted", circuitBreakerName, state), cause);
        this.circuitBreakerName = circuitBreakerName;
        this.state = state;
    }
