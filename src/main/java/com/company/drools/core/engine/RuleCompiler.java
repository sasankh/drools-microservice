...
public class RuleCompiler {
  ...
  public CompilationResult compileRules(List<Rule> rules) {
    ...
    try {
      ...
      for (Rule rule : rules) {
        String resourcePath = "src/main/resources/rules/" + rule.getRuleId().replace(".", "/") + ".drl";
      ...
      if (results.hasMessages(Message.Level.ERROR)) {
        ...
        return CompilationResult.failure("Compilation errors: " + results.getMessages(Message.Level.ERROR));
      }
