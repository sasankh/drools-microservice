...
/**
 * Interface for rule caching implementations. Supports multiple cache backends (LRU, Redis, etc.)
 */
public interface RuleCache {
  ...
  /**
   * Evicts least recently used rules if cache is full. This method is typically called internally
