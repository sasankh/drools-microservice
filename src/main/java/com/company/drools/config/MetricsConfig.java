...
/**
 * Configuration for Micrometer metrics collection and CloudWatch integration.
 * Provides custom metrics beans for rule execution, cache performance, and error tracking.
 */
@Configuration
public class MetricsConfig {
    ...
    /**
     * CloudWatch metrics registry for AWS integration.
     * Only enabled when cloudwatch.enabled=true.
     */
    @Bean
    ...
    /**
     * Timer for measuring rule execution duration.
     * Tagged by rule ID for granular monitoring.
     */
    @Bean
    ...
    /**
     * Counter for successful rule executions.
     * Tagged by rule ID for tracking individual rule performance.
     */
    @Bean
    ...
    /**
     * Counter for failed rule executions.
     * Tagged by rule ID and error type for troubleshooting.
     */
    @Bean
    ...
    /**
     * Gauge for number of loaded rules.
     * Monitors rule engine state.
     */
    @Bean
    ...
    /**
     * Timer for storage operations (S3 fetch time).
     * Measures storage backend performance.
     */
    @Bean
