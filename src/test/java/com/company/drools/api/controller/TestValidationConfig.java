...
/**
 * Test configuration to properly wire up validators with Spring beans. This ensures custom
 * validators like RuleIdValidator can inject Spring beans like ValidationConfig.
 */
@TestConfiguration
public class TestValidationConfig {

  /**
   * Create a ValidationConfig bean with test values. This bean will be injected into custom
   * validators like RuleIdValidator.
   */
  @Bean
  @Primary
  ...
  /**
   * Provide a simple MeterRegistry for tests. Avoids complex mocking of Timer/Counter interactions.
   */
  @Bean
  @Primary
  ...
  /**
   * Configure the validator factory to use Spring's application context for bean injection. This
   * allows @Autowired fields in ConstraintValidators to work properly.
   */
  @Bean
  @Primary
