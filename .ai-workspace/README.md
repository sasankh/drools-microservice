...
| [`project-plans/`](project-plans/) | Personal reference / backlog files. **Active**: `stack-modernization-plan.md` + `stack-modernization-checklist.md` (Java 17→25 + Spring Boot 3.7 + Drools 10 modernization, drafted 2026-05-09), `security-backlog.md` (the 3 unaddressed findings from "39/42"), `project-improvement-plan.md` (2026-02 sprint with 2026-05-08 status delta). **Historical**: `project-revisit-analysis.md`, `project-validation-plan.md`, `project.checklist.md`, `project.progress.md`, `project.documentation.md`, `project.prompt.md` |
